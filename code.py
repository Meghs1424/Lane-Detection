...
def region_of_interest(img, vertices):
  ...
  #Applying gamma correction to a given image
  ...
  #To extract HSV values for lane markings
  ...
  #To implement hough tranformation
...
#Getting dataset and applying 
cap = cv2.VideoCapture('C:/Users/USER/Downloads/pexels-esmanur-ekşi-5614724.mp4')
